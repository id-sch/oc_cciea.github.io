...
# --plot directory
dir_plot_out = './figures_gha/newUI/'
# dir_plot_out = './figures_x13/newUI/'
fig_type = '.png'
...
for iii in range(num_pre):
    # Monthly
    file_M = '{}{}_M.csv'.format(dir_M, file_pre[iii])
    ...
    for i in range(len(ordr_list)):
        ...
        fn_fig_M = '{}{}_{}_Monthly{}'.format(dir_plots, file_pre[iii], lat_wnt[i], fig_type)
        plt.savefig(fn_fig_M, dpi=300, bbox_inches='tight')

    # Seasons
    file_S = '{}{}_S.csv'.format(dir_S, file_pre[iii])
    ...
    for i in range(len(ordr_list)):
        ...
        fn_fig_S = '{}{}_{}_Season{}'.format(dir_plots, file_pre[iii], lat_wnt[i], fig_type)
    ...
    fn_fig_M_all = '{}{}_{}_Monthly{}'.format(
        dir_plots, file_pre[iii], lat_all, fig_type)
