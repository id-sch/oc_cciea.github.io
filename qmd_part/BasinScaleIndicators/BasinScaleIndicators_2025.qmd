...
**Indicator Category**  &nbsp; &nbsp;
`{python} vec2_oni['Component_Section'].values[0]`
 
**Data Steward**  &nbsp; &nbsp;
`{python} vec2_oni['PI'].values[0]` (`{python} vec2_oni['Contact'].values[0]`)
...
Pacific Decadal Oscillation data are served on the CCIEA ERDDAP server (<https://oceanview.pfeg.noaa.gov/erddap/tabledap/cciea_OC_PDO.html>). 
North Pacific Gyre Oscillation data are from E. Di Lorenzo (<https://www.o3d.org/npgo/index.html>).


**Figures**

::: {#fig-oni_pdo_npgo_M}
![](../../figures_gha/BasinScaleIndicators/2025/oc_ONI_PDO_NPGO_Monthly.png){width=70%}
...
![ONI](../../figures_gha/BasinScaleIndicators/2025/oc_ONI_Season.png){#fig-oni_S}

![PDO](../../figures_gha/BasinScaleIndicators/2025/oc_PDO_Season.png){#fig-pdo_S}

![NPGO](../../figures_gha/BasinScaleIndicators/2025/oc_NPGO_Season.png){#fig-npgo_S}
